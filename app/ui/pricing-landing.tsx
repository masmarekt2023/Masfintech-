  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center ">
        <h1 className="text-4xl font-bold mb-4">{t('pricingLanding.heading', 'Pricing')}</h1>
        <p className="text-lg">{t('pricingLanding.mission', 'Our mission is to make your business better through technology')}</p>
      </div>
    </motion.section>
  )
}