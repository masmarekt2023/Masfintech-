  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center ">
        <h1 className="text-4xl font-bold mb-4">{t('portfolio.heading', 'Portfolio')}</h1>
        <p className="text-lg">{t('portfolio.mission', 'Our mission is to make your business better through technology')}</p>
      </div>
    </motion.section>
  )
}